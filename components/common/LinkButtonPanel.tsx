...
export default function LinkButtonPanel({ onBack }: { onBack: () => void }) {
    ...
    const handleSave = () => {
        console.log('Link button saved:', { url, tooltip, openIn, cornerRoundness })
    }
    ...
    return (
        <div className='flex flex-col w-full h-full gap-6 bg-[#181923]'>
            <div className='flex items-center gap-3 text-white'>
                ...
                <p className='text-sm'>Link button</p>
            </div>
